...
class NPC(AnimatedSprite):
    ...
    def movement(self):
        next_pos = self.game.pathfind.get_path(self.map_pos, self.game.player.map_pos)
    ...
    def check_hit_in_npc(self):
        if self.game.player.shot and self.ray_casting_value:
    ...
    def draw_ray_cast(self):
        ...
        if self.ray_cast_player_npc():
            pg.draw.line(self.game.screen, 'orange', (100 * self.player.x, 100 * self.player.y),
